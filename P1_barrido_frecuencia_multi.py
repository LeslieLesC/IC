...
delta_frec_hz = 50 # paso del barrido en Hz PONER FREC FINAL=10*50+440
...
frec_fin_hz = 850 # frecuencia final de barrido en Hz
steps = 5 # cantidad de pasos del barrido
delta_frec_hz = (frec_fin_hz - frec_ini_hz)/steps # paso del barrido en Hz
print ('delta_frec_hz = %.1f Hz' % (delta_frec_hz))
